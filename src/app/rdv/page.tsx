    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-panel h2 {
          ...
          color: ${COLORS.greenDark}; line-height: 1.2; margin-bottom: 20px;
        }
        .info-panel h2 em { font-style: italic; color: ${COLORS.greenMid}; }
        .info-panel > p {
          font-size: 14px; font-weight: 300; line-height: 1.8;
          color: ${COLORS.greenPrimary}; opacity: 0.85; margin-bottom: 36px;
        }
        ...
        .feature-dot {
          ...
          background: ${COLORS.orangeLight}; flex-shrink: 0; margin-top: 6px;
        }
        .feature-text { font-size: 14px; line-height: 1.6; color: ${COLORS.greenPrimary}; }
        ...
        .zoom-badge {
          ...
          font-size: 13px; color: ${COLORS.greenPrimary};
        }
        .zoom-logo {
        ...
        .btn-back {
          ...
          font-size: 12px; color: rgba(240,235,204,0.4);
        ...
        .loading-box p { font-size: 14px; color: rgba(240,235,204,0.5); line-height: 1.6; }
        ...
        .btn-zoom {
          ...
          margin-top: 24px; padding: 14px 28px; border-radius: 100px;
          background: #2D8CFF; color: #fff;
          font-family: 'Jost', sans-serif; font-size: 13px; font-weight: 500;
        ...
        .btn-new {
          ...
          background: none; border: none; cursor: pointer;
          font-size: 12px; color: rgba(240,235,204,0.35);
          letter-spacing: 0.06em; text-transform: uppercase;
      ...
      <section className="page-hero">
        <div className="page-hero-inner">
          ...
          <p>
            Un accompagnement personnalisé avec un praticien certifié, en visioconférence,
      ...
      <main className="rdv-main">
        ...
        <div className="info-panel">
          ...
          <p>
            Choisissez un créneau qui vous convient, renseignez vos informations,
            et recevez votre lien Zoom immédiatement. La première séance découverte est offerte.
          </p>

          <div className="features">
            {[
              ["Choisissez votre créneau", "Disponibilités du lundi au samedi matin et après-midi."],
              ["Renseignez vos informations", "Nom, e-mail, et optionnellement ce que vous souhaitez travailler."],
              ["Recevez votre lien Zoom", "Le lien est généré automatiquement et vous est envoyé par e-mail."],
              ["Rejoignez la séance", "Cliquez sur le lien Zoom à l'heure du rendez-vous — sans application requise."],
            ].map(([title, desc]) => (
          ...
          <div className="zoom-badge">
            ...
            Séance en visioconférence · 60 minutes · Sans compte requis
          </div>
        </div>
